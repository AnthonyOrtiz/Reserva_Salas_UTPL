...
public class BLSala {
    ...
    DATSala actualizarSala = new DATSala();
    DATConexion Conexion = new DATConexion();

    public static ArrayList<Sala> arrSalas = new ArrayList<Sala>();
    
    public ArrayList<Sala> Consultar() throws ClassNotFoundException, SQLException {
        ResultSet rs;
