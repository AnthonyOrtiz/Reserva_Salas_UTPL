...
public class DATEstudiante {
    ...
    public ResultSet BuscarEstudiante(String clave) throws ClassNotFoundException, SQLException
    {
        Statement st = c.AbrirConexion().createStatement();
        String Sentencia = "SELECT NOMBRES, APELLIDOS,CEDULA, DIRECCION, MAIL, CARRERA, CICLO, MODALIDAD FROM estudiantes WHERE CEDULA ="+"'"+clave+"'";
        ResultSet rs = st.executeQuery(Sentencia);
        return rs;
    }
